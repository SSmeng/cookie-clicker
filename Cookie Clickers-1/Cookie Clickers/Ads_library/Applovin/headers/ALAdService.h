...
/**
 * @deprecated since 5.1.0; AppLovin SDK no longer uses placements.
 * This is left here for compatibility reasons.
 * Please use (void) loadNextAd: (ALAdSize *) adSize placedAt: (NSString *) placement andNotify: (id<ALAdLoadDelegate>)delegate instead.
 */
-(void) loadNextAd: (ALAdSize *) adSize placedAt: (NSString *) placement andNotify: (id<ALAdLoadDelegate>)delegate __deprecated;
